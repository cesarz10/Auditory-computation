...
%%% work.speechMaterialPath: loaded in _set.m file depending on condition
speechMaterialPath = work.speechMaterialPath; % vlmatrix_getpaths('VlMatrix'); % Get_UGent_data_paths('VlMatrix'); 
