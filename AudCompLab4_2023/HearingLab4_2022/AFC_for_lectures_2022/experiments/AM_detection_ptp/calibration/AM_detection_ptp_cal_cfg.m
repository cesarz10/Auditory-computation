...
result_path = ['D:\Fotis\afc\experiments\AM_detection_ptp\calibration\'];
...
def.intervallen = 2400000; % 22050;			% length of each signal-presentation interval in samples (might be overloaded in 'expname_set')
