...
for i = 1:num
    for k = 1:numWordAlternatives
    		...
    		kWordAlternative = def.OLSA_WordAlternativeMapping(k,i);
       ...
       'Units','normalized', ...
        'FontUnits','normalized', ...
        'BusyAction','cancel', ...
       'Callback',['vlmatrix_wordbuttonfcn(' num2str(i) ',' num2str(kWordAlternative) ')'], ...   % vlmatrix_winbutton( wordnumber, wordalternative )
        'FontSize',0.5, ...
       ...
       'Tag',['afc_button' num2str(i)]);
        ...
        % 15-04-2005 14:15 check version for >=7 and add keypressfcn to buttons
       if ( work.matlabVersion > 6 ) 
        set(b,'KeyPressFcn',['vlmatrix_wordbuttonfcn(' num2str(i) ',' num2str(kWordAlternative) ')']);
       end
...
% acceptbutton
   ...
   'Units','normalized', ...
	'FontUnits','normalized', ...
	'BusyAction','cancel', ...
   'Callback',['vlmatrix_pressfcn(5,1)'], ...   % vlmatrix_pressfcn calls function that communicates with AFC
	'FontSize',0.5, ...
   ...
   'Tag','afc_okButton');
    ...
    % 15-04-2005 14:15 check version for >=7 and add keypressfcn to buttons
   if ( work.matlabVersion > 6 ) 
   	set(b,'KeyPressFcn','vlmatrix_pressfcn(5,0)');
   end
