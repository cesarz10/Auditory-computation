# python implementation of the model2018.m
...
def run_model2018_py(stim, opts):
    output_folder = opts ['data_folder']
    clean = opts ['clean']
    numL = opts ['nL']
    numM = opts ['nM']
    numH = opts ['nH']
    non_linear_type = opts ['non_linear_type']
    IrrPct = opts ['IrrPct']
    sheraPo = opts ['sheraPo']
    subject = opts ['subject']
    storeflag = opts ['storeflag']
    irregularities = opts ['irregularities']
    fc = opts ['fc']
    Fs = opts ['fs']
    ...
    if irregularities.size == 1:
        irregularities = irregularities * np.ones((1, channels))
